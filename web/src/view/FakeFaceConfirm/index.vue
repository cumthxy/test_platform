<template>
  <div class="content-box Facial-Secondary-Review-box">
    ...
    <el-dialog v-model="AlertStatus" title="Tips" width="400">
      <span v-if="OperatType == 'no_fake'"
        >Are you sure it's not a fake Face?</span
      >
      <span v-else>Are you sure it's fake Face?</span>
      <template #footer>
  ...
  <script>
import { getRiskFace, RiskfaceOperation } from "@/api/api.js";
export default {
  data() {
    return {
      currentIndex: 0,
